...
test("create non-admin end-user login all instances", async () => {
...
test("list community and compare all instances", async () => {
  expect(true).toBe(false);
});
...
test("instance admin powers spanning instances, viewing deleted content", async () => {
...
test("behaviors spanning instances, banned from community remove-data option", async () => {
...
test("behaviors spanning instances, a user removes their account", async () => {
...
test("behaviors spanning instances, delete of an entire community", async () => {
  // Masive database transactions and social impact
  expect(true).toBe(false);
});

test("behaviors spanning instances, delete of an entire instance", async () => {
  // Masive database transactions and social impact
  expect(true).toBe(false);
});


test("behaviors spanning instances, federation outbound when subscriber count reaches zero", async () => {
...
test("behaviors spanning instances, recycle of names", async () => {
...
test("resolve report on the comment", async () => {
...
test("comment reply notification from two remote instances", async () => {
...
test("spot-check some unauthenticated user behaviors", async () => {
