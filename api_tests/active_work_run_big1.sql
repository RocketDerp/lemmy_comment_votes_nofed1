...
SELECT * FROM bench('SELECT benchmark_fill_post2(2500000, ''zy_%'');', 1, 0);
...
SELECT * FROM bench('SELECT benchmark_fill_comment_simple3(15000);', 1, 0);
SELECT 'simple comment4' AS status_message;
SELECT * FROM bench('SELECT benchmark_fill_comment_simple4(40000);', 1, 0);
