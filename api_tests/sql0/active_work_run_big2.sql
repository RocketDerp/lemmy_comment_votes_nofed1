...
SELECT * FROM bench('SELECT benchmark_fill_post2(5123000, ''zy_%'');', 1, 0);
...
SELECT * FROM bench('SELECT populate_temp_post_id_table(75000, ''zy_%'');', 1, 0);
...
SELECT * FROM bench('SELECT benchmark_fill_comment_simple4(80000);', 1, 0);
...
SELECT 'benchmark_fill_comment_reply_using_temp0_extendbranch ROUND 1 kicking off 8 runs level 2' AS status_message;
SELECT * FROM bench('SELECT benchmark_fill_comment_reply_using_temp0_extendbranch(7500, 2);', 8, 0);
SELECT 'benchmark_fill_comment_reply_using_temp0_extendbranch ROUND 1 kicking off 8 runs level 3' AS status_message;
SELECT * FROM bench('SELECT benchmark_fill_comment_reply_using_temp0_extendbranch(5200, 3);', 8, 0);
...
SELECT 'benchmark_fill_comment_reply_using_temp0_extendbranch ROUND 3 kicking off 8 runs level 5' AS status_message;
SELECT * FROM bench('SELECT benchmark_fill_comment_reply_using_temp0_extendbranch(5200, 5);', 8, 0);
SELECT 'benchmark_fill_comment_reply_using_temp0_extendbranch ROUND 4 kicking off 5 runs level 6' AS status_message;
SELECT * FROM bench('SELECT benchmark_fill_comment_reply_using_temp0_extendbranch(5200, 6);', 5, 0);
...
SELECT 'benchmark_fill_comment_reply_using_temp0_extendbranch ROUND 5 kicking off 3 runs level 8' AS status_message;
SELECT * FROM bench('SELECT benchmark_fill_comment_reply_using_temp0_extendbranch(3200, 8);', 3, 0);
...
SELECT 'benchmark_fill_comment_reply_using_temp0_extendbranch ROUND 5 kicking off 6 runs level 10' AS status_message;
SELECT * FROM bench('SELECT benchmark_fill_comment_reply_using_temp0_extendbranch(12500, 10);', 6, 0);
SELECT 'benchmark_fill_comment_reply_using_temp0_extendbranch ROUND 5 kicking off 3 runs level 11' AS status_message;
SELECT * FROM bench('SELECT benchmark_fill_comment_reply_using_temp0_extendbranch(4800, 11);', 3, 0);
