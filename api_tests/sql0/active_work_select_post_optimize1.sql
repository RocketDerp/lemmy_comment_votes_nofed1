...
(
   ...
   (
     (
       ...
       -- this is the essence of a "subscribed" post listing, JOIN on subscribe list then filtering out status
  ...
  -- adding this one clause turns this into a query that takes 4 full MINUTES!!!
